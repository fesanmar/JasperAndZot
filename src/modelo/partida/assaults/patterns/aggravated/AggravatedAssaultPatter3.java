...
public class AggravatedAssaultPatter3 implements AssaultPattern
{
	private Partida partida;
	
	public AggravatedAssaultPatter3(Partida partida)
	{
	...
	public void placeTokens(Token... tokens) throws WrongNumberOfTokensException
	{
		...
		try
		{
			...
			casilla2 = partida.getTablero().getCasilla(1, partida.getAppearDice().getResult() - 2);			
		}
