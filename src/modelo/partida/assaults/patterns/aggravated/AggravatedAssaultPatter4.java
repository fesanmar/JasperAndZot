...
public class AggravatedAssaultPatter4 implements AssaultPattern
{
	private Partida partida;
	
	public AggravatedAssaultPatter4(Partida partida)
	{
	...
	public void placeTokens(Token... tokens) throws WrongNumberOfTokensException
	{
		...
		else if (partida.getAppearDice().getResult() == 6)
		{
			...
			casilla2 = partida.getTablero().getCasilla(0, partida.getAppearDice().getResult() - 1);
			casilla3 = partida.getTablero().getCasilla(1, partida.getAppearDice().getResult() - 3);
		}
		else
		{
